  ...
  return (
    <>
      ...
      <section className="relative flex flex-row items-center justify-between min-h-[100vh] py-12 bg-[#020c1b] text-white px-6 md:px-10 overflow-hidden hero-section-mobile">
        ...
        <div className="flex flex-col items-start text-left z-10 relative w-full">
        ...
        <motion.div
          className="relative w-full p-6 bg-gray-900 rounded-lg shadow-lg border border-gray-700 overflow-hidden text-left terminal-mobile"
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 1 }}
        >
